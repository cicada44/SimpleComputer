...
$(TEST_PATH): $(TEST_OBJECTS) $(LIB_COMPUTER_PATH) $(LIB_TERM_PATH) $(LIB_BIGCHAR_PATH) $(LIB_READKEY_PATH) $(LIB_COMMON_PATH)
	$(CC) $(CFLAGS) $(CPPFLAGS) $^ -o $@
...
.PHONY: clean
clean:
	$(RM) $(APP_PATH) $(LIB_COMPUTER_PATH) $(LIB_TERM_PATH) $(TEST_PATH) $(LIB_BIGCHAR_PATH) $(LIB_READKEY_PATH) $(LIB_COMMON_PATH)
...
TESTING_PROGS=testing

test_rk: 
	$(CC) $(CFLAGS) $(CPPFLAGS) $(TESTING_PROGS)/$@/$@.c -o $@
